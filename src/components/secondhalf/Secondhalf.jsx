...
const Secondhalf = () => {
    return (
        <div className='flex flex-col mt-16 md:flex-row md:mt-0 md:h-35v'>
            ...
            {/* SECOND SECTION */}
            <section className='container md:w-40v md:flex md:items-center 2xl:px-20'>
                <div className=' space-y-4'>
                    {/* TITLE */}
                    <div className=' mt-12 md:mt-0'>
                        <h2 className=' font-bold text-bigsm 2xl:text-bigbase'>A B O U T&nbsp;&nbsp;&nbsp;O U R&nbsp;&nbsp;&nbsp;F U R N I T U R E</h2>
                    </div>
                    {/* SECOND PARAGRAPH */}
                    <div className=' mt-4 md:mt-0'>
                        <p className=' text-darkGray text-sm font-medium pr-2 leading-6 text-left md:pr-0 md:text-bigsm md:font-normal 2xl:text-base 2xl:pr-5'>
